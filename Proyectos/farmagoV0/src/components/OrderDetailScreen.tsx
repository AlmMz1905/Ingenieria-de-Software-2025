    ...
    <div className="flex-1 p-6 space-y-6 bg-gradient-to-br from-emerald-50/50 via-white to-teal-50/50">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="space-y-6">
          ...
          {/* Order completed message with Print Options */}
              ...
              <Card className="border-4 border-purple-300 shadow-2xl bg-gradient-to-br from-white to-purple-50">
                <CardHeader className="bg-gradient-to-r from-purple-500 to-pink-500 text-white">
                  ...
                  <CardDescription className="text-purple-50">
                    Imprime los comprobantes necesarios
                  </CardDescription>
                </CardHeader>
                <CardContent className="p-6 space-y-3">
                  <Button
                    onClick={() => {
                      toast.success("Generando Comprobante de Venta...");
                      // Aquí iría la lógica real de impresión
                    }}
                    className="w-full h-auto py-4 bg-gradient-to-r from-purple-500 to-pink-500 hover:from-purple-600 hover:to-pink-600 text-white shadow-lg"
                  >
                    <div className="flex items-center gap-3">
                      <div className="w-10 h-10 bg-white/20 rounded-lg flex items-center justify-center">
                        <Printer className="h-6 w-6" />
                      ...
                      <div className="text-left">
                        <p className="font-semibold text-base">Imprimir Comprobante de Venta</p>
                        <p className="text-xs text-purple-100">Documento fiscal del pedido</p>
                      </div>
                    </div>
                  </Button>
                  ...
                  <Button
                    onClick={() => {
                      toast.success("Generando Comprobante de Entrega...");
                      // Aquí iría la lógica real de impresión
                    }}
                    className="w-full h-auto py-4 bg-gradient-to-r from-indigo-500 to-blue-500 hover:from-indigo-600 hover:to-blue-600 text-white shadow-lg"
                  >
                    <div className="flex items-center gap-3">
                      <div className="w-10 h-10 bg-white/20 rounded-lg flex items-center justify-center">
                        <Printer className="h-6 w-6" />
                      ...
                      <div className="text-left">
                        <p className="font-semibold text-base">Imprimir Comprobante de Entrega</p>
                        <p className="text-xs text-indigo-100">Constancia de recepción</p>
                      </div>
                    </div>
                  </Button>
                  ...
                  <div className="p-3 bg-purple-50 rounded-lg border border-purple-200 mt-4">
                    <p className="text-xs text-purple-800">
                      <strong>Nota:</strong> Los comprobantes se generarán en formato PDF y se enviarán automáticamente a la impresora configurada.
                    </p>
                  </div>
                </CardContent>
              </Card>
